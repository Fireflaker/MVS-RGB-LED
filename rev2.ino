...
int rrv1 = 1;// randNumber = random(0, 1);
int rrv2 = 0;
int rrv3 = 1;
int rgv1 = 1;
int rgv2 = 1;
...
long intervalLength = 500;     // f at which to blink (microseconds)
...
//5x
  ...
  switch (mode) {
    ...
    case 3://$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$  MODE 3 strobe
      {
        intervalLength = intervalLength + change * 10;
        ...
        if (currentMicros - previousMicros > intervalLength * 1000) {
          previousMicros = currentMicros;
          if (ledState == LOW)
            ledState = HIGH;
          else
    ...
    case 4://$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$  MODE 4 randomColor
      {
 intervalLength = intervalLength + change * 10;
delay(intervalLength/10);

        digitalWrite(r1,  random(4));
        digitalWrite(g1,  random(4));
        digitalWrite(b1,  random(4));
        digitalWrite(r2,  random(4));
        digitalWrite(g2,  random(4));
        digitalWrite(b2,  random(4));
        digitalWrite(r3,  random(4));
        digitalWrite(g3,  random(4));
        digitalWrite(b3,  random(4));
